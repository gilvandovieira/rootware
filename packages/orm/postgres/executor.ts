import type { SqlParameter } from "../core/mod.ts";
...
export function createPgExecutor(
  ...
  return new RootwarePgExecutor(resolvePgConnectionSource(options));
}

class RootwarePgExecutor implements PgSqlExecutor {
