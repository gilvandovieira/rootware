/**
 * Pure SQLite DDL generation from `@rootware/schema` snapshots.
 *
 ...
 */
export function generateSqliteColumnType(type: RootwareColumnType): string {
  switch (type.kind) {
    case "integer":
    case "bigint":
    case "smallint":
...
function renderSqliteDefault(value: RootwareColumnDefault): string {
